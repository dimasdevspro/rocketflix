...
<p>Projeto que utiliza a API do themoviedb.org para exibir filmes aleatórios sempre que clicar em "Encontrar Filme".</p>
...
$ git clone https://github.com/dimasdevspro/rocketflix
